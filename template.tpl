...

{
  ...
  "description": "trivago tag for setting up the trv_reference cookie for booking conversion purposes.",
  "containerContexts": [
    "WEB"
  ]
}
...
[
  ...
  },
  {
    "type": "TEXT",
    "name": "placeholder",
    "displayName": "Parameter name of click ID",
    "simpleValueType": true,
    "defaultValue": "trv_reference"
  }
]
...
Created on 16/12/2019, 13:39:24
